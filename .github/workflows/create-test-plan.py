...
JOB_SPECS = {
    ...
    "wiiu": JobSpec(name="Nintendo Wii U",                                  os=JobOs.UbuntuLatest,      platform=SdlPlatform.WiiU,
    artifact="SDL-wiiu",               container="devkitpro/devkitppc:latest", ),
...
def spec_to_job(spec: JobSpec, key: str, trackmem_symbol_names: bool) -> JobDetails:
    ...
    match spec.platform:
        ...
        case SdlPlatform.WiiU:
            ...
            job.cmake_arguments.append("-DSDL_THREADS=OFF")
            job.static_lib = StaticLibType.A
